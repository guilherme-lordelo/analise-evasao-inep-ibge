...
from inep.carregamento_pares import ler_pares_evasao, merge_pares
from inep.validacao import separar_validos_invalidos
from inep.ponderacao import calcular_media_ponderada
from inep.agregacao_evasao import agrega_evasao
