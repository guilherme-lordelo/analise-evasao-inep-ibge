...
from brpipe.utils.paths import RAW_INEP, INEP_REDUZIDO

from brpipe.inep.extracao import orquestrar_extracao
from brpipe.inep.checkpoints import salvar_checkpoint
